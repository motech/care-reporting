 ...
 */
@Entity
@Table(name = "ui_child_form", uniqueConstraints = @UniqueConstraint(columnNames = "form_id"))
public class UiChildForm implements java.io.Serializable {
	...
	public UiChildForm(int id, ChildCase childCase, Flw flw, String formId,
			...
			Date opvBoosterDate, Date vitA1Date) {
		this.id = id;
