 ...
 */
@Entity
@Table(name = "ebf_mother_form", uniqueConstraints = @UniqueConstraint(columnNames = "form_id"))
public class EbfMotherForm implements java.io.Serializable {
	...
	public EbfMotherForm(int id, MotherCase motherCase, Flw flw, String formId,
			Date timeend, Date timestart, Date dateModified, Date addval,
			Boolean adoptImmediately, Boolean askPpiud, Boolean awareOfFailure,
			Boolean bleeding, String children, Boolean complications,
			Boolean condoms, Boolean counselFollowUpPpiud,
			Boolean counselFollowUpPptl, Boolean counselMenstrualCycle,
			Boolean counselMethods, Boolean counselPpfp,
			Boolean counselTimeIud, Date dateEb1, Date dateEb2, Date dateEb3,
			Date dateEb4, Date dateEb5, Date dateEb6, Date dateIudAdopted,
			Date dateLastInj, Date dateLastVisit, Date dateNextCf,
			Date dateNextEb, Boolean discharge, Boolean distension,
			Short ebVisitNum, String familyPlanningType, Boolean fever,
			Boolean haveCondoms, Boolean headaches, Boolean highBp,
