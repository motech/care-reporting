 ...
 */
@Entity
@Table(name = "cf_child_form", uniqueConstraints = @UniqueConstraint(columnNames = "form_id"))
public class CfChildForm implements java.io.Serializable {
	...
	public CfChildForm(int id, ChildCase childCase, Flw flw, String formId,
