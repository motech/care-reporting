 ...
 */
@Entity
@Table(name = "pnc_mother_form", uniqueConstraints = @UniqueConstraint(columnNames = "form_id"))
public class PncMotherForm implements java.io.Serializable {
	...
	public PncMotherForm(int id, MotherCase motherCase, Flw flw, String formId,
