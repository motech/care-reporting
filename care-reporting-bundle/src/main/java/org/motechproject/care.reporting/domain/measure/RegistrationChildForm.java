 ...
 */
@Entity
@Table(name = "registration_child_form", uniqueConstraints = @UniqueConstraint(columnNames = "form_id"))
public class RegistrationChildForm implements java.io.Serializable {
	...
	public RegistrationChildForm(int id, MotherCase motherCase,
			FlwGroup flwGroup, ChildCase childCase, Flw flw, String formId,
