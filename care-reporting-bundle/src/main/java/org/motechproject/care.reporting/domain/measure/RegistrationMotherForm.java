 ...
 */
@Entity
@Table(name = "registration_mother_form", uniqueConstraints = @UniqueConstraint(columnNames = "form_id"))
public class RegistrationMotherForm implements java.io.Serializable {
	...
	public RegistrationMotherForm(int id, MotherCase motherCase, Flw flw,
			...
			Boolean continuePreg, String deliveryNature, String displayName,
			String dobEst, Date eddCalc, Boolean eddKnown, String education,
			Boolean fever, Boolean firstPregnancy, Short gestAge,
			Boolean goodToRegister, Boolean inDistrict, Boolean injectible,
			Boolean isPregnant, Boolean iudUsed, Boolean jsyBeneficiary,
			Boolean jsyMoney, Integer lastPreg, Boolean lastPregCSection,
