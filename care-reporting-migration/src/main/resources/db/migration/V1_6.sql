ALTER TABLE report.bp_form
    ADD COLUMN anc1_weight VARCHAR(20) DEFAULT NULL,
    ADD COLUMN anc1_hemoglobin INTEGER DEFAULT NULL,
    ADD COLUMN anc2_weight VARCHAR(20) DEFAULT NULL,
    ADD COLUMN anc2_hemoglobin INTEGER DEFAULT NULL,
    ADD COLUMN anc3_weight VARCHAR(20) DEFAULT NULL,
    ADD COLUMN anc3_hemoglobin INTEGER DEFAULT NULL,
    ADD COLUMN anc4_weight VARCHAR(20) DEFAULT NULL,
